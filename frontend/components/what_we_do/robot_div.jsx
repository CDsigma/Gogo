        ...
        return (
            <div className="robot-div">
                <div className="robot-content">
                    ...
                    <p className="robot-p">Indiegogo's crowdfunding campaigns are where new and groundbreaking products take 
                        ...
                        backers. Before it's everywhere, it's on Indiegogo.</p>
                </div>
            </div>
        )
    }
